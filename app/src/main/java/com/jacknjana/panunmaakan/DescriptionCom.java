...
public class DescriptionCom extends AppCompatActivity {

    //Added on 31072020
    EditText etComPropDesc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_description_com);
        ...
        name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DescriptionCom.this, MainActivity.class));
            }
        });
        //----------------Action Bar Ends--------------//

        etComPropDesc = findViewById(R.id.etComPropDesc);
    ...
    public void DescriptionComBtn(View view) {

        String regNo = RegNo;
        Integer propId = PropId;
        String description = etComPropDesc.getText().toString();
    ...
    class SendJsonDataToServer extends AsyncTask<String,String,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                //  URL url = new URL("http://192.168.43.91:8081/saveComPropDesc");
               URL url = new URL(getUrl+"saveComPropDesc");
...
//response data
        ...
        protected void onPreExecute() {
            ...
            alertDialog = new AlertDialog.Builder(DescriptionCom.this).create();
        ...
        protected void onPostExecute(String result) {
            ...
            if (result==null){
                Toast.makeText(DescriptionCom.this, "No Internet ", Toast.LENGTH_SHORT).show();
            }
                ...
                // homeIntentMethod();
                Toast.makeText(DescriptionCom.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(DescriptionCom.this, "Garbar hai baba....",Toast.LENGTH_SHORT).show();
